...
from pyAudioAnalysis import testShortTermFeatures
eps = 0.00000001
...
def mid_feature_extraction(signal, sampling_rate, mid_window, mid_step,
    ...
    short_features, short_feature_names = \
        testShortTermFeatures.feature_extraction(signal, sampling_rate,
                                             short_window, short_step)
...
def mid_feature_extraction(signal, sampling_rate, mid_window, mid_step, short_window, short_step):
    short_features, short_feature_names = testShortTermFeatures.feature_extraction(signal, sampling_rate, short_window, short_step)
    n_stats = 2
    n_feats = len(short_features)
...
def mid_feature_extraction_to_file(file_path, mid_window, mid_step, short_window, short_step, output_file, store_short_features=False, store_csv=False, plot=False):
    ...
    mid_features, short_features, _ = mid_feature_extraction(
...
mid_feature_extraction_to_file(input_file, mid_window, mid_step, short_window, short_step, output_file, store_short_features=True, store_csv=True, plot=True)